...
document.getElementById('start-game').addEventListener('click', () => {
  let p1 = new Player(document.getElementById('1pColor').value);
  let p2 = new Player(document.getElementById('2pColor').value);
  let p3 = new Player(document.getElementById('3pColor').value);
